...
async def lifespan(app: FastAPI):
    ...
    try:
        async with async_session() as db:
            ...
            row = result.first()
            if row and row[0] not in ("001_initial", "002_rewatch", "003_watch_history", "004_watch_history_genres", "005_watch_history_progress", "006_dedup_watch_history", "007_simkl", "008_user_rating"):
